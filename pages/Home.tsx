...
const carouselImages = [
    ...
    {
        src: 'images/girl-outside-classroom2.png',
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-6 mt-16">
                ...
                <ProgramCard title="Junior High" img="images/spsrandom41.jpg" link="/academics#junior-high" className="lg:col-span-2" />
                <ProgramCard title="Senior High" img="images/spsrandom47.jpg" link="/academics#senior-high" className="lg:col-span-2" />
            </div>
        </div>
      </section>
