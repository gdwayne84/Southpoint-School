...
const AcademicLevel: React.FC<{ title: string; description: string; imageUrl: string; reverse?: boolean }> = ({ title, description, imageUrl, reverse = false }) => (
    <div className={`flex flex-col md:flex-row items-center gap-8 md:gap-12 mb-16 ${reverse ? 'md:flex-row-reverse' : ''}`}>
